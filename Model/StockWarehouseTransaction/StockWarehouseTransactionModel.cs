...
namespace Model
{
    public class StockWarehouseTransactionModel
    {
        ...
        public virtual StockTransactionTypeModel StockTransactionType { get; set; }
        public virtual TrasactionReferenceModel TrasactionReference { get; set; }
    }
}
