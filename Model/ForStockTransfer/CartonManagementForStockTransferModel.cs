...
{
	public class CartonManagementForStockTransferModel
	{
		public CartonManagementForStockTransferModel()
		{
		...
		public virtual List<CartonManagementDetailForStockTransferModel> CartonMgmtDetailsStockTransfers { get; set; }
