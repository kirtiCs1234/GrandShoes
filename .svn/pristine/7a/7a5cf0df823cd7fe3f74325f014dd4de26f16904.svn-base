...
namespace Model
{
   public class StoreDeliveryReportModel
    {
        public StoreDeliveryReportModel()
        {
            TotalDistributes = new List<StockDistributionModel>();
            listStoreDeleviry = new List<StoreDeliveryReportModel>();
        }
        public int Id { get; set; }
        public int? ProductId { get; set; }
        public int? BranchId { get; set; }
        public List<StoreDeliveryReportModel> listStoreDeleviry { get; set; }
       public DateTime FromDate { get; set; }
        ...
        public List<StockDistributionModel> TotalDistributes { get; set; }
